...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "I would advise making a backup copy of the file before using o.copyfile, just in case"
								}
